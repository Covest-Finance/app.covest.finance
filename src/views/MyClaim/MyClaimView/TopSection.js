                ...
                <Box sx={{ flexGrow: 1 }}>
                    <Grid container spacing={2}>
                        <Grid item xs={12} md={4}>
                            <PoolCardArea>
                                <PoolCardTopArea>
                                    <PoolCardTopicText>{totalData.totalPolicyValue ?? 0} USD</PoolCardTopicText>
                        ...
                        <Grid item xs={12} md={4}>
                            <PoolCardArea>
                                <PoolCardTopArea>
                                    <PoolCardTopicText>{totalData.totalClaimValue ?? 0} USD</PoolCardTopicText>
                                    <PoolButton variant="outlined" href="/claimrequest" passHref>
                                        Request Claim
                                    </PoolButton>
                                </PoolCardTopArea>
                                <PoolCardFooterArea>
                        ...
                        <Grid item xs={12} md={4}>
                            <PoolCardArea>
                                <PoolCardTopArea>
                                    <PoolCardTopicText>{totalData.totalMIValue ?? 0} USD</PoolCardTopicText>
