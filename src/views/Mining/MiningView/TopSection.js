                    ...
                    <FilterRightArea>
                        <FilterRightControlArea>
                            <FormControl fullWidth>
                                ...
                                <Select labelId="demo-simple-select-label" id="demo-simple-select" value={provider} label="Service Provider" onChange={handleChange}>
                    ...
                    <Grid container spacing={2}>
                        {poolData.map((pool, indexPool) => (
                            <Grid key={indexPool} item xs={12} md={3}>
                                <TopSectionDetail key={indexPool} poolName={pool.poolName} poolValue={pool.poolValue}></TopSectionDetail>
                            </Grid>
                        ))}
                    </Grid>
                </Box>
