...
async function sendFiles(file) {
    ...
    const response = await axios.post(`http://165.22.109.117:8081/uploadFile`, formData, {
        headers: {
                ...
                <FormControl fullWidth>
                    <Grid item xs={12} md={12}>
                        <Stack spacing={2} direction="row">
                            ...
                            <Button variant="contained" onClick={() => RequestClaim(values.topic, policyData, values.claimAmount, values.lossAmount, values.description, fileValue, accountAddress)}>
                                Submit Item
                            </Button>
                        </Stack>
                    </Grid>
