...
async function buyPolicy(poolId, planId, referral, currency) {
    ...
    if (approveBalance >= buyValue) {
        ...
        await SendTranscation(IERC20, currencyAddress, "approve", [policyManager, BigNumber(buyValue).toString()], account[0]);
...
const RenderDetail = (paramValue) => {
    ...
    const linkReferrer = `https://app.covest.finance/ref?addr=${account}`;
              ...
              <p>4. Proceed with the cover purchase on this page.</p>
                ...
                <CardArea>
                    <CardInnerArea>
                        ...
                        <p>
                            The premium payment conditions accept 3 types of stable coin tokens (USDT, BUSD, and USDC). In the event of a claim, you will be reimbursed in the specified token that you
                            paid for the premium up to the insured amount.
                        </p>
            ...
            <CheckoutRightArea>
                <CardArea>
                    <CardInnerArea>
                        ...
                        <ButtonArea>
                            <Button variant="contained" onClick={() => buyPolicy(paramValue.poolId, paramValue.planId, referral, currency)}>
                                Purchase
                            </Button>
                        </ButtonArea>
                    </CardInnerArea>
...
const MainSection = () => {
    ...
    if ((poolId != undefined) & (account != undefined) && account != "xx") {
        return <RenderDetail poolId={poolId} planId={planId} account={account}></RenderDetail>;
    } else {
